...
if __name__ == "__main__":
    ...
    for dataset_name in tested_datasets:
        ...
        train_xses_series, train_ys, test_xses_series, test_ys = load_preprocessed_data(
            test_path=pathlib.Path(f'./data/Univariate_ts/{dataset_name}/{dataset_name}_TEST.ts'),
            train_path=pathlib.Path(f'./data/Univariate_ts/{dataset_name}/{dataset_name}_TRAIN.ts'),
            derivative_order=1)
